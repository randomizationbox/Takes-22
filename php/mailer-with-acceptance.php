...
if($_POST)
{
	$to_email = "info@takes22.com"; //Recipient email, Replace with own email here
	...
	$user_name		= filter_var($_POST["name"], FILTER_SANITIZE_SPECIAL_CHARS);
	$user_email		= filter_var($_POST["email"], FILTER_SANITIZE_EMAIL);
	$message		= filter_var($_POST["message"], FILTER_SANITIZE_SPECIAL_CHARS);
	$subject		= filter_var($_POST["subject"], FILTER_SANITIZE_SPECIAL_CHARS);
	$acceptance		= filter_var($_POST["checkbox"], FILTER_SANITIZE_SPECIAL_CHARS);
